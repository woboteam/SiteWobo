<?php include_once("views/index/v_header.php");?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="listmenu.php">Menu Footer</a></li>
          ...
          <div class="box box-info">
            <div class="box-body pad">
              <form id="form_add_news" enctype="multipart/form-data">
                <div class="row">
                  <div class="col-md-6">
                    <div id="menu_name_valid" class="form-group">
                      <input type="hidden" id="menu_id" name="menu_id" value="<?php echo $menu_current->menu_id;?>">
                      <label>Tên chuyên mục</label>
                      <input type="text" id="menu_name" name="menu_name" class="form-control" placeholder="Nhập tên chuyên mục" onblur="isempty('#menu_name_valid',this);" value="<?php echo $menu_current->menu_name;?>">
                    </div>
                    <div id="menu_slug_valid" class="form-group">
                      <label>Tên đường dẫn</label>
                      <input type="text" id="menu_slug" name="menu_slug" class="form-control" placeholder="Ví dụ: menu-1" onblur="isempty('#menu_slug_valid',this);"  value="<?php echo $menu_current->menu_slug;?>">
                    </div>
                    
                  </div>
                  <div class="col-md-6">
                    <div id="menu_parent_valid" class="form-group">
                      <label>Menu cha</label>
                      <select name="menu_parent" class="form-control select2" style="width: 100%;">
                        <option value="0" <?php if($menu_current->menu_parent==0){ echo 'selected="selected"';}?>> --- Chuyên mục gốc --- </option>
                        <?php
                        if ($list_menu_parent!=false){
                          foreach ( $list_menu_parent as $menu) {
                        ?>
                        <option value="<?php echo $menu->menu_id;?>" <?php if ($menu->menu_id==$menu_current->menu_parent){ echo 'selected="selected"';}?>><?php echo $menu->menu_name;?></option>
                        <?php
                          }
                        }
                        ?>
                    ...
                    <div class="form-group">
                      <label>Thứ tự</label>
                      <input type="text" id="menu_order" name="menu_order" class="form-control" placeholder="Số thứ tự" value="<?php echo $menu_current->menu_order;?>">
                    </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4 col-xs-4">
                    <button type="button" class="btn btn-block btn-default btn-flat" onclick="location.href='listmenu.php'">Xem List</button>
                  </div>
                </div> 
              </form> 
            </div><!-- /.box-body -->
    ...
    <script>
        ...
        $.ajax({
            ...
            success: function(response){
              ...
              if(response==="success"){
                  ...
                  $("#menu_slug_valid").addClass('has-error');
      ...
      function isvalid(){
        flag = true;
        var file_img = document.getElementById("menu_img");
        if($("#menu_name").val().trim()===""){
          $("#menu_name_valid").addClass('has-error');
          flag = false;
        } 
        return flag;
      }
