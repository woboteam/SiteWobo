           		...
           		<div class="box box-info">
                    ...
                    <div class="col-sm-6">
                      <div class="dataTables_length">
                        <div class="append_button"><label class="m-t-2"><a class="btn btn-social-icon btn-success m-r-1" href="addmenu.php" title="Thêm chuyên mục mới"><i class="fa fa-plus"></i></a></label></div>
                      </div>
                    </div>
                  </div>
      					</div><!-- /.box-header -->
                    ...
                    <ul class="nav">
                        <?php
                        if ($list_menus_1!=false){
                        foreach ($list_menus_1 as $val_menu_1) {
                        ?>
                        <li class="dt-<?php echo $val_menu_1->menu_id;?>">
                            <a class="ct-left" href="#"><?php echo $val_menu_1->menu_name;?></a>
                            <div class="ct-right" ><a href="edit_menu.php?id=<?php echo $val_menu_1->menu_id;?>"> Sửa </a> <?php if($val_menu_1->menu_id!=9 && $val_menu_1->menu_id!=1 && $val_menu_1->menu_id!=6){ echo '| <a href="javascript:void(0);" onclick="process_delete('.$val_menu_1->menu_id.')"> Xóa</a>';}?></div>
                            <?php
                            $m_menu_in = $m_menu->get_menu_parent($val_menu_1->menu_id);
                            if ($m_menu_in){
                            ?>
                            <ul class="nav nav-second-level">
                                <?php
                                }
                                foreach ($m_menu_in as $val_menu_in) {
                                ?>
                                <li class="dt-<?php echo $val_menu_in->menu_id;?>">
                                    <a class="ct-left" href="#"><?php echo $val_menu_in->menu_name;?></a>
                                    <div class="ct-right" ><a href="edit_menu.php?id=<?php echo $val_menu_in->menu_id;?>"> Sửa</a> | <a onclick="process_delete(<?php echo $val_menu_in->menu_id;?>)" href="javascript:void(0);"> Xóa</a></div>
                                </li>
                            <?php 
                                }
                            if ($m_menu_in){
