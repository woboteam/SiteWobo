<?php include_once("views/index/v_header.php");?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="listmenus.php">Menu</a></li>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div id="menu_name_valid" class="form-group">
                      ...
                      <input type="text" id="menu_name" name="menu_name" class="form-control" placeholder="Nhập tên menu" onblur="isempty('#menu_name_valid',this);">
                    </div>
                    <div id="menu_slug_valid" class="form-group">
                      <label>Tên đường dẫn</label>
                      <input type="text" id="menu_slug" name="menu_slug" class="form-control" placeholder="Ví dụ: menu-1" onblur="isempty('#menu_slug_valid',this);">
                    </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <label>Thứ tự</label>
                      <input type="text" id="menu_order" name="menu_order" class="form-control" placeholder="Số thứ tự">
                    </div>
    ...
    <script>
      ...
      $("form#form_add_news").submit(function(e){
        ...
        $.ajax({
            ...
            success: function(response){
              ...
              // alert(response);
              if(response==="success"){
                  bootbox.alert("Thêm menu thành công");
                 // $('#form_add_news')[0].reset();
                  setTimeout(function(){window.location.reload(1);}, 1500);
              } else if (response==="duplicate") {
                  bootbox.alert("Tên menu hoặc đường dẫn đã bị trùng. Vui lòng thay đổi tên hoặc đường dẫn khác");
      ...
      function isvalid(){
        ...
        // if ($("#menu_slug").val().trim()===""){
        //   $("#menu_slug_valid").addClass('has-error');
        //   flag = false;
        // }
        
        // if (file_img.value.length===0){
        //   $("#menu_img_valid").addClass('has-error');
        //   flag = false;
        // }
        return flag;
      }
      function isempty(id,obj){
        if($(obj).val().trim()===""){
          ...
          if(id==="#menu_name_valid"){
            $("#menu_slug").val(slug($(obj).val().trim()));
          }
        }
      }
      ...
      function ValidateSingleInput(oInput) {
          if (oInput.type == "file") {
              ...
              if (sFileName.length > 0) {
                  var blnValid = false;
                  if (oInput.name==="menu_img"){
                      $("#menu_img_valid").removeClass('has-error').addClass('has-success');
                  }
                  ...
                  if (!blnValid) {
                      oInput.value = "";
                      if (oInput.name=="menu_img"){
                          $("#menu_img_valid").removeClass('has-success').addClass('has-error');
                      }
