                ...
                <div class="row">
                  <div class="col-md-6">
                    <div id="cate_name_valid" class="form-group">
                      ...
                      <input type="text" id="cate_name" name="cate_name" class="form-control" placeholder="Nhập tên chuyên mục" onblur="isempty('#cate_name_valid',this);">
                    </div>
                    <div id="cate_slug_valid" class="form-group">
                      <label>Tên đường dẫn</label>
                      <input type="text" id="cate_slug" name="cate_slug" class="form-control" placeholder="Ví dụ: cate-1" onblur="isempty('#cate_slug_valid',this);">
                    </div>
                    <div id="cate_img_valid" class="form-group">
                      <label>Hình ảnh đại diện chuyên mục</label>
                      <input type="file" id="cate_img" name="cate_img" class="form-control" onchange="ValidateSingleInput(this);">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div id="cate_parent_valid" class="form-group">
                      ...
                      <select name="cate_parent" class="form-control select2" style="width: 100%;">
                        <option value="0" selected="selected"> --- Chọn chuyên mục cha --- </option>
                        <?php
                    ...
                    <div class="form-group">
                      <label>Thứ tự</label>
                      <input type="text" id="cate_order" name="cate_order" class="form-control" placeholder="Số thứ tự">
                    </div>
        ...
        $.ajax({
            ...
            success: function(response){
              $(".loader").fadeOut("slow");
               // alert(response);
              if(response==="success"){
                  bootbox.alert("Thêm chuyên mục thành công");
          ...
          if (oInput.type == "file") {
              ...
              if (sFileName.length > 0) {
                  ...
                  if (oInput.name==="cate_img"){
                      $("#cate_img_valid").removeClass('has-error').addClass('has-success');
                  }
                  ...
                  if (!blnValid) {
                      oInput.value = "";
                      if (oInput.name=="cate_img"){
                          $("#cate_img_valid").removeClass('has-success').addClass('has-error');
                      }
