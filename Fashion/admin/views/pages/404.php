        ...
        <section class="content">
          <div class="error-page">
            ...
            <div class="error-content">
              <h3><i class="fa fa-warning text-yellow"></i> Xin lỗi! Trang yêu cầu không tìm thấy.</h3>
              <p>
                Chúng tôi không tìm thấy trang mà bạn yêu cầu.
                Hãy nhấn vào <a href="index.php">Dashboard</a> để trở về trang Dashboard.
            </div><!-- /.error-content -->
          </div><!-- /.error-page -->
        </section><!-- /.content -->
      </div><!-- /.content-wrapper -->
      <?php include_once("../index/v_footer.php");?>
