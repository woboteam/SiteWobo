                ...
                <div class="box-body pad">
                  <form id="form_add_pages" enctype="multipart/form-data">
                    <div id="pages_name_valid" class="form-group">
                      <input type="hidden" id="pages_id" name="pages_id" class="form-control" value="<?php echo $current_pages->pages_id; ?>">
                      <label>Tiêu đề</label>
                      <input type="text" id="pages_name" name="pages_name" class="form-control" placeholder="Ví dụ: Ford Focus 1.6L Trend 5 Cửa" onblur="isempty('#pages_name_valid',this);" value="<?php echo $current_pages->pages_name; ?>">
                    </div>
                    <div id="pages_slug_valid" class="form-group">
                      <label>Tên đường dẫn</label>
                      <input type="hidden" id="pages_slug_src" name="pages_slug_src" class="form-control" value="<?php echo $current_pages->pages_slug;?>">
                      <input type="text" id="pages_slug" name="pages_slug" class="form-control" placeholder="Ví dụ: Ford Focus 1.6L Trend 5 Cửa" onblur="isempty('#pages_slug_valid',this);" value="<?php echo $current_pages->pages_slug; ?>">
                    </div>
                    <div class="form-group">
                      <label>Bài viết chi tiết</label>
                      <textarea id="editor1" name="pages_content" rows="10" cols="80">
                        <?php echo $current_pages->pages_content;?>
                      </textarea>
                    </div>
                    <div class="row">
            ...
            success: function(response){
              ...
              if(response==="success"){
                 ...
                 // $('#form_add_product')[0].reset();
                  ...
                  bootbox.alert("Tên Pages hoặc đường dẫn đã bị trùng. Vui lòng thay đổi tên hoặc đường dẫn khác");
