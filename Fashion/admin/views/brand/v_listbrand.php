...
?>
                    ...
                    <div class="col-sm-6">
                      <div class="dataTables_length">
                        <div class="append_button"></div>
      					...
      					<div class="box-body">
      					  <table id="dataTables_timer" class="table table-bordered table-striped table-hover">
      					    <thead>
      					      <tr>
    ...
    <div class="modal fade" id="model_timer_detail" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title text-primary" id="myModalLabel">Chi tiết hiệu xe</h4>
            </div>
    ...
    <script type="text/javascript" src="dist/js/table_bootstrap_timer.js"></script>
  </body>
</html>