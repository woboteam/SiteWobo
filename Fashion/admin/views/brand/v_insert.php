                ...
                <div class="box-body pad">
                  <form id="form_add_timer" enctype="multipart/form-data">
                    <div id="brand_name_valid" class="form-group">
                      <label>Hiệu xe</label>
                      <input type="text" id="brand_name" name="brand_name" class="form-control" placeholder="Nhập hiệu xe" onblur="isempty('#brand_name_valid',this);">
                    </div>
                    <div id="brand_slug_valid" class="form-group">
                      <label>Tên đường dẫn</label>
                      <input type="text" id="brand_slug" name="brand_slug" class="form-control" placeholder="Ví dụ: toyota" onblur="isempty('#brand_slug_valid',this);">
                    </div>
                    
                    <div class="row">
                      <div class="col-md-4 col-xs-4">
                        <button type="button" onclick="submit_add_timer();" class="btn btn-block btn-success btn-flat">Thêm</button>
                      </div>
                      <div class="col-md-4 col-xs-4">
        ...
        $.ajax({
            ...
            success: function(response){
              $(".loader").fadeOut("slow");
               // alert(response);
              if(response==="success"){
                  bootbox.alert("Thêm hiệu xe thành công");
                 // $('#form_add_timer')[0].reset();
      ...
      function isempty(id,obj){
        if($(obj).val().trim()===""){
          ...
          if(id==="#brand_name_valid"){
            $("#brand_slug").val(slug($(obj).val().trim().substring(0,99)));
          }
        }
      }
