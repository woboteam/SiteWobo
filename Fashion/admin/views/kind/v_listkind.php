                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="dataTables_length">
                        <div class="append_button"><label class="m-t-2"><a class="btn btn-social-icon btn-success m-r-1" href="addkind.php" title="Thêm chuyên mục mới"><i class="fa fa-plus"></i></a></label></div>
                      </div>
                    </div>
                  </div>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <div class="sidebar-nav categories">
                    <ul class="nav">
                        ...
                        ?>
                        <li class="dt-<?php echo $val_brand->brand_id;?>">
                            <a class="ct-left" href="#"><?php echo $val_brand->brand_name;?></a>
                            <div class="ct-right" ><a href="edit_brand.php?id=<?php echo $val_brand->brand_id;?>"> Sửa </a></div>
                            <?php
                            $list_kind = $m_kind->get_kind_by_brand($val_brand->brand_id);
                            if ($list_kind!=false){
                            ?>
                            <ul class="nav nav-second-level">
                                ...
                                ?>
                                <li class="dt-<?php echo $val_kind->kind_id;?>">
                                    <a class="ct-left" href="#"><?php echo $val_kind->kind_name;?></a>
                                    <div class="ct-right" ><a href="edit_kind.php?id=<?php echo $val_kind->kind_id;?>"> Sửa</a> | <a onclick="process_delete(<?php echo $val_kind->kind_id;?>)" href="javascript:void(0);"> Xóa</a></div>
                                </li>
                            <?php 
                                }
                            ?>
