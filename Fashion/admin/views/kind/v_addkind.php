                ...
                <div class="row">
                  <div class="col-md-6">
                    <div id="kind_name_valid" class="form-group">
                      <label>Dòng xe</label>
                      <input type="text" id="kind_name" name="kind_name" class="form-control" placeholder="Nhập tên chuyên mục" onblur="isempty('#kind_name_valid',this);">
                    </div>
                    <div id="kind_slug_valid" class="form-group">
                      <label>Tên đường dẫn</label>
                      <input type="text" id="kind_slug" name="kind_slug" class="form-control" placeholder="Ví dụ: cate-1" onblur="isempty('#kind_slug_valid',this);">
                    </div>
    ...
    <script>
        ...
        $.ajax({
            ...
            success: function(response){
              $(".loader").fadeOut("slow");
               // alert(response);
              if(response==="success"){
                  bootbox.alert("Thêm donfng xe thành công");
      ...
      function isempty(id,obj){
        if($(obj).val().trim()===""){
          ...
          if(id==="#kind_name_valid"){
            $("#kind_slug").val(slug($(obj).val().trim()));
          }
        }
      }
