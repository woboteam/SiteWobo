...
?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="contact.php" title="Liên hệ">Liên hệ</a></li>
          </ol>
        </section>
                    ...
                    <div class="col-sm-6">
                      <div class="dataTables_length">
                        <div class="append_button"></div>
      					...
      					<div class="box-body">
      					  <table id="dataTables_contact" class="table table-bordered table-striped table-hover">
      					    <thead>
      					      <tr>
    ...
    <div class="modal fade" id="model_contact_detail" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title text-primary" id="myModalLabel">Chi tiết liên hệ</h4>
            </div>
    ...
    <script type="text/javascript" src="dist/js/table_bootstrap_contact.js"></script>
  </body>
</html>