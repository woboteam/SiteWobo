...
?>
                    ...
                    <div class="col-sm-6">
                      <div class="dataTables_length">
                        <div class="append_button"></div>
      					...
      					<div class="box-body">
      					  <table id="dataTables_slider" class="table table-bordered table-striped table-hover">
      					    <thead>
      					      <tr>
    ...
    <div class="modal fade" id="model_slider_detail" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    <script type="text/javascript" src="dist/js/table_bootstrap_sliders.js"></script>
  </body>
</html>