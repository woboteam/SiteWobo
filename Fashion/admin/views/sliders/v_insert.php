                ...
                <div class="box-body pad">
                  <form id="form_add_slider" enctype="multipart/form-data">
                    <div id="slider_name_valid" class="form-group">
                      <label>Tiêu đề</label>
                      <input type="text" id="slider_name" name="slider_name" class="form-control" placeholder="Nhập tên slider" onblur="isempty('#slider_name_valid',this);">
                    </div>
                    
                    <div id="slider_img_valid" class="form-group">
                      <label>Hình ảnh slider (1900 x 1060)</label>
                      <input type="file" id="slider_img" name="slider_img" class="form-control" onchange="ValidateSingleInput(this);">
                    </div>
                    <div class="form-group">
                      <label>Mô tả</label>
                      <textarea id="slider_desc" name="slider_desc" class="textarea" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                    </div>
                    
                    <div class="row">
                      <div class="col-md-4 col-xs-4">
                        <button type="button" onclick="submit_add_slider();" class="btn btn-block btn-success btn-flat">Thêm</button>
                      </div>
                      <div class="col-md-4 col-xs-4">
    ...
    <script>
      ...
      $("form#form_add_slider").submit(function(e){
        ...
        $.ajax({
            ...
            success: function(response){
              ...
              // alert(response);
              if(response==="success"){
                  bootbox.alert("Thêm slider thành công");
      ...
      function isvalid(){
        ...
        if (file_img.value.length===0){
          $("#slider_img_valid").addClass('has-error');
          flag = false;
        }
        CKupdate();
        return flag;
