<div class="content_middle_leftbar">
  <div class="single_category wow fadeInDown">
    <?php
       $cate_id_1=$m_cate->get_cate_id(1);    
    ?> 
   <h2> <span class="bold_line"><span></span></span> <span class="solid_line"></span> <a href="#" class="title_text"><?php  echo $cate_id_1->cate_name;?></a> </h2>
     
      <ul class="catg1_nav">

       <?php
        $cate_pr_1=$m_cate->get_cate_parent(1);
        $arr_cate = array();
        $list_cate = array();
        foreach ($cate_pr_1 as $val_cate_pr_1) {               
          array_push($arr_cate, $val_cate_pr_1->cate_id);
