    ...
    <ul class="fashion_catgnav wow fadeInDown">
      ...
      ?>
        <li>
          ...
          <div class="comments_box"> <span class="meta_date"><?php echo date("d/m/Y",strtotime($val_product->pro_create));?></span> <span class="meta_comment"><a href="<?php echo $pathweb ?>views/<?php echo $val_product->pro_slug . '-' . $val_product->pro_id; ?>.html">Comments (<?php echo $val_product->pro_view; ?>)</a></span> <span class="meta_more"><a  href="<?php echo $pathweb ?>views/<?php echo $val_product->pro_slug . '-' . $val_product->pro_id; ?>.html">Xem thêm...</a></span> </div>
      ...
      <li>
        <div class="media wow fadeInDown"> <a class="media-left" href="<?php echo $pathweb ?>views/<?php echo $val_product->pro_slug . '-' . $val_product->pro_id; ?>.html"><img src="public/products/<?php echo $val_product->pro_img; ?>" alt=""></a>
          <div class="media-body">
            ...
            <div class="comments_box"> <span class="meta_date"><?php echo date("d/m/Y",strtotime($val_product->pro_create));?></span> <span class="meta_comment"><a href="<?php echo $pathweb ?>views/<?php echo $val_product->pro_slug . '-' . $val_product->pro_id; ?>.html">Comments (<?php echo $val_product->pro_view; ?>)</a></span> </div>
          </div>
        </div>
      </li>
      <?php } }?>     
