<div class="games_category">
  <div class="single_category">
    ...
    ?>
      <li>
        <div class="media"> <a class="media-left" href="<?php echo $pathweb ?>views/<?php echo $val_product->pro_slug . '-' . $val_product->pro_id; ?>.html"><img src="public/products/<?php echo $val_product->pro_img; ?>" alt=""></a>
