              ...
              <div class="business_category_left wow fadeInDown">
                <ul class="fashion_catgnav">
                  <li>
                    ...
                    <a href="<?php echo $pathweb;?>views/<?php echo $val_product->pro_slug.'-'.$val_product->pro_id;?>.html"><img alt="" src="<?php echo $pathweb;?>public/products/<?php echo $val_product->pro_img;?>"></a> 
                    </div>
